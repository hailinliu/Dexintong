    ...
    private void registerListener() {
        ...
        pullToRefreshListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                if (replacePages > 0 && replacePages >= currentPage) {
                    replaceGoodsHttp(currentPage);
                    currentPage++;
                } else {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        ReplaceGoodsBean.DataBean mReplaceGoodsBean = replaceGoodsBean.getData();
                        if (mReplaceGoodsData == null) {
                            mReplaceGoodsData = new ArrayList<ReplaceGoodsBean.DataBean.ListBean>();
                        }
                        mReplaceGoodsData.addAll(mReplaceGoodsBean.getList());
                        if (mReplaceGoodsData.size() == 0) {
