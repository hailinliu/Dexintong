...
import com.runtai.newdexintong.module.personalcenter.adapter.YouHuiQuan_ysy_Adapter;
...
public class UsedCouponFragment extends BaseFragment {
    ...
    private PullToRefreshListView yhq_ysy_list;
    YouHuiQuan_ysy_Adapter adapter;
    private int pages;
    private int total;
    ...
    protected void onCreateView(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_coupon_used);
    ...
    public void initView(View view) {
        yhq_ysy_list = (PullToRefreshListView) view.findViewById(R.id.yhq_ysy_list);
        yhq_ysy_list.setHeaderLayout(new HeaderLayout(getActivity()));
        yhq_ysy_list.setFooterLayout(new FooterLayout(getActivity()));
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (code == 200) {
                        ...
                        yhq_ysy_list.onRefreshComplete();//刷新UI
                        adapter = new YouHuiQuan_ysy_Adapter(getActivity(), listData);
                        yhq_ysy_list.setAdapter(adapter);
                    } else if (code == 403) {
    ...
    private void registerListener() {
        ...
        yhq_ysy_list.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
...
//        if (isVisibleToUser) {
//            Log.e("优惠券——已使用", "显示状态" + isVisibleToUser);
//            if (!isfirst) {
//                Log.e("优惠券——已使用，请求数据", "这里应该正常了");
//                currentPage = 2;
...
//            }
//        } else {
//            Log.e("优惠券——已使用", "隐藏状态" + isVisibleToUser);
//        }
//    }
}