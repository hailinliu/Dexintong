...
public class RechargeAccountQueryAdapter extends BaseAdapter {

    private Context mContext;
    private List<RechargeAccountQueryBean.DataBean.ListBean> mData;
    private final LayoutInflater mInflater;

    public RechargeAccountQueryAdapter(Context mContext, List<RechargeAccountQueryBean.DataBean.ListBean> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RechargeAccountQueryBean.DataBean.ListBean listBean = mData.get(position);
