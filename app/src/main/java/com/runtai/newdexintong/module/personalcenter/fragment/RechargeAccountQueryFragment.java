...
import com.runtai.newdexintong.module.personalcenter.adapter.RechargeAccountQueryAdapter;
import com.runtai.newdexintong.module.personalcenter.bean.RechargeAccountQueryBean;
...
public class RechargeAccountQueryFragment extends BaseFragment {
    ...
    private List<RechargeAccountQueryBean.DataBean.ListBean> mData;
    private int pages;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        RechargeAccountQueryBean rechargeAccountQueryBean = gson.fromJson(strJson, RechargeAccountQueryBean.class);
                        RechargeAccountQueryBean.DataBean data = rechargeAccountQueryBean.getData();
                        if (mData == null) {
                            mData = new ArrayList<RechargeAccountQueryBean.DataBean.ListBean>();
                        }
                        ...
                        RechargeAccountQueryAdapter adapter = new RechargeAccountQueryAdapter(getActivity(), mData);
