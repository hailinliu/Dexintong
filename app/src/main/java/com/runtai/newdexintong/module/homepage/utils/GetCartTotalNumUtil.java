...
/**
 * @author：rhf
 * @date：2017/11/2time19:56
 * @detail：读取购物车中商品数量
 */

public class GetCartTotalNumUtil {

    /**
     * 获取当前购物车中商品总数量
     */
    public static void getShoppingCartNumber(final Context mContext) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        SPUtils.putString(mContext, "TotalNumber", String.valueOf(data.getNum()));
                    } else if (code == 403) {
