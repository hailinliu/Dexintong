...
public class ReturnGoodsFragment extends BaseFragment {
    ...
    List<ReturnGoodsBean.DataBean.ListBean> mRetrunData;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        ReturnGoodsBean returnGoodsBean = gson.fromJson(strJson, ReturnGoodsBean.class);
                        ReturnGoodsBean.DataBean data = returnGoodsBean.getData();
                        if (mRetrunData == null) {
                            mRetrunData = new ArrayList<ReturnGoodsBean.DataBean.ListBean>();
                        }
