 ...
 */
public class ScanResultListAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public ScanResultListAdapter(Context context, List<SearchResultBean.DataBean.ListBean> datas) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final SearchResultBean.DataBean.ListBean bean = mDatas.get(position);
        ...
        holder.tv_create_time.setText(bean.getMfd());//生产日期
...
//                    initPopuWindow(position);
    ...
    public static HashMap<Integer, Boolean> getIsShow() {
        return ScanResultListAdapter.isShow;
    }

    public static void setIsShow(HashMap<Integer, Boolean> isShow) {
        ScanResultListAdapter.isShow = isShow;
    }
