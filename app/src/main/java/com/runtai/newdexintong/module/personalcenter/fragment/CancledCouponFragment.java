...
import com.runtai.newdexintong.module.personalcenter.adapter.YouHuiQuan_yzf_Adapter;
import com.runtai.newdexintong.module.personalcenter.bean.MyCouponBean;
import com.runtai.newdexintong.module.personalcenter.bean.WoDeJiFen_Bean;
 ...
 * @描述：已作废
 */
public class CancledCouponFragment extends BaseFragment {

    private PullToRefreshListView yhq_yzf_list;
    YouHuiQuan_yzf_Adapter adapter;
    List<WoDeJiFen_Bean> list;
    private int pages;
    private int total;
    ...
    protected void onCreateView(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_coupon_cancled);
    ...
    public void initView(View view) {
        ...
        yhq_yzf_list = (PullToRefreshListView) view.findViewById(R.id.yhq_yzf_list);
        yhq_yzf_list.setHeaderLayout(new HeaderLayout(getActivity()));
        yhq_yzf_list.setFooterLayout(new FooterLayout(getActivity()));
    ...
    private void httpCouponData(int page) {
        ...
        OkHttpUtils.post().url(url).addHeader(AppConstant.HEADER_NAME, AppConstant.HEADER_VERSION)
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        pages = data.getPages();
                        total = data.getTotal();
                        LogUtil.e("UsedCoupon", "总页数" + pages + ".....总条目数" + total);
                        yhq_yzf_list.onRefreshComplete();//刷新UI
                        adapter = new YouHuiQuan_yzf_Adapter(getActivity(), listData);
                        yhq_yzf_list.setAdapter(adapter);
            ...
            public void onError(Request request, Exception e) {
                LogUtil.e("usedcoupon", e.toString());
            }
        });
    ...
    private void registerListener() {
        ...
        yhq_yzf_list.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
