package com.runtai.newdexintong.module.personalcenter.view.timepickerview;
...
import com.runtai.newdexintong.module.personalcenter.view.timepickerview.lib.ScreenInfo;
import com.runtai.newdexintong.module.personalcenter.view.timepickerview.lib.WheelTime;
...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
	...
	public TimePopupWindow(Context context, Type type) {
		...
		View view_popuwindow_bg = rootView.findViewById(R.id.view_popuwindow_bg);
		//点击周边关闭popuwindow
