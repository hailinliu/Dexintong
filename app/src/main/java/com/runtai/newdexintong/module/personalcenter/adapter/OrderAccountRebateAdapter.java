...
public class OrderAccountRebateAdapter extends BaseAdapter {

    private Context mContext;
    private List<OrderAccountRebateBean.DataBean.ListBean> mData;
    private final LayoutInflater mInflater;

    public OrderAccountRebateAdapter(Context mContext, List<OrderAccountRebateBean.DataBean.ListBean> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        OrderAccountRebateBean.DataBean.ListBean listBean = mData.get(position);
