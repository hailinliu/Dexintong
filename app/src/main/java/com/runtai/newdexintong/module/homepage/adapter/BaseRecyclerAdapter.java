...
public class BaseRecyclerAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    ...
    public BaseRecyclerAdapter(Context context, List<Object> listDatas) {
     ...
     */
    public BaseRecyclerAdapter(Context context, List<Object> listDatas, OnViewClickListener onViewClickListener) {
        init(context,listDatas);
