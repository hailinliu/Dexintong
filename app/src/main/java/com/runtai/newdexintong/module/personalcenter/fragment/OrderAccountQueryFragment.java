...
import com.runtai.newdexintong.module.personalcenter.adapter.OrderAccountQueryAdapter;
...
public class OrderAccountQueryFragment extends BaseFragment {
    ...
    protected void onCreateView(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_order_account_query);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        OrderAccountQueryBean orderAccountQueryBean = gson.fromJson(strJson, OrderAccountQueryBean.class);
                        OrderAccountQueryBean.DataBean data = orderAccountQueryBean.getData();
                        if (mData == null) {
                            mData = new ArrayList<OrderAccountQueryBean.DataBean.ListBean>();
                        }
                        ...
                        OrderAccountQueryAdapter adapter = new OrderAccountQueryAdapter(getActivity(), mData);
