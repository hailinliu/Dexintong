package com.runtai.zxinglib.zxing;
...
import com.runtai.zxinglib.R;
import com.runtai.zxinglib.zxing.camera.CameraManager;
import com.runtai.zxinglib.zxing.decode.DecodeThread;
import com.runtai.zxinglib.zxing.decode.PhotoScanHandler;
import com.runtai.zxinglib.zxing.decode.RGBLuminanceSource;
import com.runtai.zxinglib.zxing.utils.BeepManager;
import com.runtai.zxinglib.zxing.utils.BitmapUtil;
import com.runtai.zxinglib.zxing.utils.CaptureActivityHandler;
import com.runtai.zxinglib.zxing.utils.InactivityTimer;
...
public class ScanManager implements SurfaceHolder.Callback {
    ...
    void initCrop() {
        ...
        Log.e("x", "" + x);
        Log.e("y", "" + (y));
        Log.e("width + x", "" + (width + x));
        Log.e("height + y", "" + (height + y));
